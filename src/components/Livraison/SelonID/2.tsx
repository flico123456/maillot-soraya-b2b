...
// If Checkbox is from Radix UI, use:
import { Checkbox } from '@radix-ui/react-checkbox';

// Or, if you have a Checkbox component in your project, correct the path:
        ...
        const fetchShippingMethods = async () => {
            try {
                const methodsResponse = await fetch(
                    `https://maillotsoraya-conception.com/wp-json/wc/v3/shipping/zones/2/methods`,
                    {
                        headers: {
